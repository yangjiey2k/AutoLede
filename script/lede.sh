...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='小杰的私人定制固件'' package/lean/default-settings/files/zzz-default-settings
sed -i "s/OpenWrt /YJ @ KoNanWrt /g" package/lean/default-settings/files/zzz-default-settings
