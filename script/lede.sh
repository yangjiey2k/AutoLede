...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='阿努比斯'' package/lean/default-settings/files/zzz-default-settings
sed -i "s/OpenWrt /KoNan - 阿努比斯 /g" package/lean/default-settings/files/zzz-default-settings
